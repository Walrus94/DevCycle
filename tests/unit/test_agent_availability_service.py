...
class TestAgentAvailabilityService:
    ...
    def mock_agent(self):
        ...
        agent.capabilities = [AgentCapability.TEXT_PROCESSING, AgentCapability.ANALYSIS]
    ...
    async def test_is_agent_available_cache_miss(self, service, mock_agent):
        ...
        with patch.object(service, "_get_agent_by_id") as mock_get_agent:
    ...
    async def test_is_agent_available_busy_agent(self, service, mock_agent):
        ...
        mock_agent.configuration.max_concurrent_tasks = 5
    ...
    async def test_is_agent_available_maintenance_agent(self, service, mock_agent):
        ...
        mock_agent.status = AgentStatus.MAINTENANCE
...
class TestAgentAvailabilityServiceIntegration:
    ...
    @pytest.mark.asyncio
    async def test_complete_availability_workflow(self):
        ...
        mock_agent.configuration = config
